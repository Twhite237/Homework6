...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      # Selectize inputs for X and Y
      selectInput(
        "corr_x",
        label = "x Variable",
        choices = 
          c("Total person's income" = "PINCP",
            "Water cost" = "WATP", 
      ...
      # Radio buttons for subsetting data
      radioButtons("hhl_corr", "Household Language", 
                  ...
                  selected = "all"),
      radioButtons("fs_corr", "SNAP Recipiency", 
